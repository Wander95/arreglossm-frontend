...
const Product = () => {
  const hoverEffect = `transition duration-300 transform rounded shadow-2xl hover:scale-105 md:shadow-xl hover:shadow-2xl`
  return (
    <div className={`w-80 flex justify-center items-center ${hoverEffect}`}>
      <div className="w-full p-4">
        ...
        <div className="prod-img">
          <img src="https://www.tailwind-kit.com/images/object/4.jpg" className="w-full object-cover object-center" />
        </div>
